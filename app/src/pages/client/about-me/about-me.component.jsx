            ...
            <div className='col-12 col-lg-6 order-2 text-center'>
              <em className='d-lg-flex flex-column justify-content-center h-100'>
                ...
                <span className='content d-block mb-5 text-secondary'>
                  ...
                  Îmi doresc să aflăm împreună ce se întâmplă cu tine și să te ajut să dobândești o perspectivă mai rațională și mai obiectivă asupra diferitelor situații sau probleme cu care te confrunți.
                </span>
