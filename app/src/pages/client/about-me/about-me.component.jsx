      ...
      <div className='about-me'>
        ...
        <div className='row mx-0 mt-5'>
          <div className='col-12 col-lg-6 order-2 order-lg-1 text-center'>
            <em className='d-lg-flex flex-column justify-content-center'>
              <h3 className='title d-block mt-5 mt-lg-0 mb-5 mb-lg-3'>Bună! Eu sunt Iulia.</h3>
              <span className='content d-block mb-3'>
              ...
              <span className='content d-block mb-5'>
              ...
              <span className='content d-block mb-3 mt-2'>
