  ...
  constructor() {
    ...
    this.state = {
      services: [
        ...
        { name: 'Evaluarea psihologică pentru deținerea și utilizarea armelor și munițiilor supuse autorizării', description: 'Avizul psihologic pentru permisul de port armă este un document care atestă faptul că o persoană este aptă pentru a deține și utiliza o armă letală/neletală.', icon: faHammer },
