              ...
              <Card.Body className='ps-0'>
                <blockquote className='blockquote mb-0'>
                  <ul className='navbar-nav ms-auto'>
                    ...
                    <li className='navbar-item'><a className='nav-link py-0 text-secondary' href='https://facebook.com/psihologiuliagherasa' target='_blank' rel='noreferrer'><FontAwesomeIcon icon={faFacebook} /> Facebook</a></li>
